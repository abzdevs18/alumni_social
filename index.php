<?php 
	...
	<main>
		...
		<div class="people">
			...
			<span id="signText">NORSU-SC ALUMNI MONITORING SYSTEM<br><i>Reconnect with your Alma Mater</i></span>
		</div>
		<div class="registrationForm">
			...
			<form class="go-bottom" action="inc/sign_up.php" method="POST">
				...
				<div style="display: flex;flex-direction: row;">
					<div style="margin-right: 10px;width: calc( 100% / 2);" class="l_s_form">    
						<input id="name" name="name" type="text" required>    
						<label for="name">Name</label>  
					</div>  
					<div style="position: relative;width: calc( 100% / 2);" class="l_s_form">    
				...
				<div class="l_s_form">  
					<input id="email" name="address" type="text" required>    
					<label for="address">Address</label>  
				</div> 
				<div class="l_s_form">  
					<input id="text" name="contact_num" type="text" required>    
					<label for="contact_num">Contact #</label>  
				</div> 
				<div style="display: flex;flex-direction: row;">
					<div style="margin-right: 10px;width: calc( 100% / 2);" class="l_s_form">    
						<input id="name" name="password" type="password" required>    
						<label for="name">Password</label>  
					</div>  
					<div style="position: relative;width: calc( 100% / 2);" class="l_s_form">    
						<input id="lastname" name="confirm-password" type="password" style="background-color: none;" required>    
						<label for="lastname">Confirm Password</label>  
					</div>
				</div> 
				<div>
					<select id="position" class="position" type="text" name="yearGrad">						
					...
					<label for="position">Year Graduated</label>
				</div>
				<!-- <div>
					<select id="position" class="position" type="text" name="emStatus">						
				...
				<div>
					<select id="position" class="position" type="text" name="course">
					  <option value="BSInt" selected>B.S. in Information Technology</option>
					  <option value="BSCrim">B.S. in Criminal Education</option>
					  <option value="BSBA">B.S. in Business Administration</option>
					  <option value="BSED">Bachelor of Secondary Education</option>
					  <option value="BSEE">Bachelor of Elemenatary Education</option>
					  <option value="BSHM">B.S. in Hotel Management</option>
					</select>
